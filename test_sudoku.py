...
class TestSudokuSolver(unittest.TestCase):
    def test_valid_sudoku(self):
        ...
        self.assertEqual(solve_sudoku(board), expected)
    ...
    def test_unsolvable_sudoku(self):
        unsolvable_board = [
            ...
            [0, 6, 0, 0, 0, 0, 2, 8, 0],
            [0, 0, 0, 4, 1, 9, 0, 0, 5],
            [5, 0, 0, 0, 8, 0, 0, 7, 9],  # Invalid duplicate '5'
        ]
    ...
    def test_empty_board(self):
        ...
        self.assertIsNotNone(solve_sudoku(empty_board))
    ...
    def test_filled_valid_board(self):
        ...
        self.assertEqual(solve_sudoku(filled_board), filled_board)
    ...
    def test_partial_solution(self):
        ...
        self.assertIsNotNone(solve_sudoku(partial_board))
